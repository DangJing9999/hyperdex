...
// import tns from 'tns-react-component'
import $ from 'jquery'
import 'jquery.appear'
import 'jquery-validation'
import ReactGA from 'react-ga4'

ReactGA.initialize('G-VGWYXL1VVP')
...
*/
  ...
  */
  ...
  $(document).ready(function() {
    ...
    setTimeout(function() {
      $('.s-bottom').toggleClass('bottom');
      $('.s-top').toggleClass('top');
    }, 2*t);
    
    setTimeout(function() {
      $('.s-bottom').toggleClass('tilt');
      $('.s-top').toggleClass('tilt');
    }, 3*t);
    
    setTimeout(function() {
      $('.s-bottom').toggleClass('legs');
      $('.s-top').toggleClass('legs');
    }, 4*t);
